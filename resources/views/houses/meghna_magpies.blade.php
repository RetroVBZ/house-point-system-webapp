...
<head>
    ...
    <title>Meghna Magpies - Houses</title>
    @vite(['resources/css/house.css', 'resources/js/house.js'])
</head>
<body>
    <div class="background" style="--bg: url('{{ asset('images/meghna.png') }}')">
        <div class="top_tab">
        ...
        <div class="main_content">
            <div class="info_container">
                ...
                <div class="members_dropdown">
                    ...
                    <form method="GET" action="{{ route('meghna_magpies') }}" id="gradeFilterForm">
        ...
        <div class="layered_bg1" style="--bg: url('{{ asset('images/magpie_bg.png') }}')"></div>
        <div class="layered_bg2" style="--bg: url('{{ asset('images/magpie_bg.png') }}')"></div>
        <div class='credit'>
